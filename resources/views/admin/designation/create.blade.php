...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        <li class="breadcrumb-item">
            <a href="{{ route('admin.designation.index')}}" class="text-muted">Designations</a>
        </li>
        <li class="breadcrumb-item">
            <a href="{{ route('admin.designation.create')}}" class="text-muted">Add designation</a>
        </li>
    </ul>
@endsection
    ...
    <div class="col-md-12">
        <div class="card card-custom example example-compact">
            <div class="card-header">
                ...
                <a href="{{ route('admin.designation.index') }}"><button type="submit" class="btn btn-primary">Save</button></a>
                   
                </div>
            </div>
            <!--begin::Form-->
            <form class="form" method="POST" action="{{ route('admin.designation.store') }}">
                <div class="form-group row mt-3 justify-content-center">
                    <label class="col-form-label text-right col-lg-2">Designation<span class="text-danger">*</span></label>
                    <div class="col-lg-3">
