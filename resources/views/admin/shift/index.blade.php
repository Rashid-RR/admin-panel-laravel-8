                                                ...
                                                <div class="form-row mt-3">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="example-time-input">End Time* (e.g. 09:00
                                                            PM)</label>
                                                        <input class="form-control" type="time" name="endTime" value="--:-- --"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <a href="" id="shiftEditBtn" data-id="{{$item}}" data-toggle="modal" data-target="#edit-modal-lg"
                                            ...
                                            <form action="" method="POST" id="shiftEditData">
                                                {{ @method_field('PUT') }}
                                                @csrf
                                                                ...
                                                                <form action="" method="post">
                                                                    <div class="form-group row">
                                                                        <label
                                                                            ...
                                                                            Name</label>
                                                                        <div class="col-lg-12 col-xl-12">
                                                                            <input type="text" class="form-control shiftName"
                                                                    ...
                                                                    <div class="form-group mt-1">
                                                                        ...
                                                                        <div class="checkbox-inline mt-4">
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"
                                                                                    name="monday" value="1" class="monday" />
                                                                                <span></span>Monday</label>
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"
                                                                                name="tuesday" value="1" class="tuesday" />
                                                                                <span></span>Tuesday</label>
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"
                                                                                name="wednesday" value="1" class="wednesday" />
                                                                                <span></span>Wednesday</label>
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"
                                                                                name="thursday" value="1" class="thursday" />
                                                                                <span></span>Thursday</label>
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"
                                                                                name="friday" value="1" class="friday"/>
                                                                                <span></span>Friday</label>
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"
                                                                                name="saturday" value="1" class="saturday" />
                                                                                <span></span>Satuday</label>
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"
                                                                                name="sunday" value="1" class="sunday"/>
                                                                                <span></span>Sunday</label>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                            ...
                                            <a href="" id="shiftDeltailBtn" data-id="{{$item}}" data-toggle="modal" data-target="#detail-modal-lg"
                                                class="btn btn-sm btn-clean btn-icon mr-2" title="details">
                                                <span class="fas fa-eye"></span> </a>
                                            
                                            <div class="modal fade" id="detail-modal-lg" tabindex="-1" role="dialog"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="" method="post">
                                                                ...
                                                                <label class="col-lg-2 col-form-label">Working
                                                                    Hour</label>
                                                                <div class="col-lg-6" style="padding: 0">
                                                                    <input type="text" name="workingHours" value="" class="form-control workingHours2"
                                                                        required disabled/>
                                                                </div>
                                                                <div class="form-row mt-3">
                                                                    <div class="form-group col-md-6">
                                                                        <label for="example-time-input">Start
                                                                            Time* (e.g. 09:00 AM)</label>
                                                                        <input class="form-control startTime2" type="time"
                                                                            value="" name="startTime"
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        <label for="example-time-input">End
                                                                            Time* (e.g. 09:00 PM)</label>
                                                                        <input class="form-control endTime2" type="time"
                                                                            value="" name="endTime"
                                                                            id="example-time-input" disabled/>
                                                                    </div>
                                                                ...
                                                                <div class="form-group mt-1">
                                                                    ...
                                                                    <div class="checkbox-inline mt-4">
                                                                        <label class="checkbox">
                                                                            <input type="checkbox"
                                                                                name="monday" value="1" class="monday2" disabled/>
                                                                            <span></span>Monday</label>
                                                                        <label class="checkbox">
                                                                            <input type="checkbox"
                                                                            name="tuesday" value="1" class="tuesday2" disabled/>
                                                                            <span></span>Tuesday</label>
                                                                        <label class="checkbox">
                                                                            <input type="checkbox"
                                                                            name="wednesday" value="1" class="wednesday2" disabled/>
                                                                            <span></span>Wednesday</label>
                                                                        <label class="checkbox">
                                                                            <input type="checkbox"
                                                                            name="thursday" value="1" class="thursday2" disabled />
                                                                            <span></span>Thursday</label>
                                                                        <label class="checkbox">
                                                                            <input type="checkbox"
                                                                            name="friday" value="1" class="friday2" disabled/>
                                                                            <span></span>Friday</label>
                                                                        <label class="checkbox">
                                                                            <input type="checkbox"
                                                                            name="saturday" value="1" class="saturday2" disabled/>
                                                                            <span></span>Satuday</label>
                                                                        <label class="checkbox">
                                                                            <input type="checkbox"
                                                                            name="sunday" value="1" class="sunday2" disabled/>
                                                                            <span></span>Sunday</label>
                                                                    </div>
                                                                </div>
                                                            </form>
